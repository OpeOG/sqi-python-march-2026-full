...
try:
    ...
    if response.status_code == 200:
       ...
       # another method to find the number of books
        ...
        try:
            ...
            print("Average price: ", None)
        # another method to find the average price
        # books = soup.find_all("article", class_="product_pod")
...
# another method to get the most expensive book
# books = soup.find_all("article", class_="product_pod")
...
# print("Most expensive book:", most_expensive_title)
